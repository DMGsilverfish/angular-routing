...
> **A simple To-Do List using routing**

---

## ✨ What It Does
This project demonstrates how to use **Angular services and routing** in a practical to-do list scenario:

- ✅ Create tasks  
- 🔄 Complete tasks 
- 🔍 Sort using url queries  
- 🛠️ Showcase **Routing** using Angular
